...
public class MiniPlayerController : NetworkBehaviour {
    ...
    [SyncVar(hook = "OnCoinsChange")] public int Coins;
    ...
    [SyncVar(hook = "OnFlagChange")] public string FlagColor = "";
    ...
    [SyncVar(hook = "OnWeaponChange")] public string WeaponSpriteName;
    ...
    public override void OnStartAuthority() {
        ...
        // Notify UI
        if (MiniGameUi.Instance != null) MiniGameUi.Instance.OnPlayerSpawned(this);
    }
    ...
    public void SetWeapon(string name) {
        if (isServer) WeaponSpriteName = name;
    ...
    public IEnumerator DisplayName() {
        ...
        while (true) {
            ...
            _nameObject.transform.position = RectTransformUtility
                                                 .WorldToScreenPoint(Camera.main, NameTransform.position) +
                                             Vector2.up * 30;
