...
public class UnetGameRoom : NetworkBehaviour {
    ...
    [Header("Room properties")] public string MapName = "Amazing Map";
    ...
    [Header("Room options")] [Tooltip("This address will be sent to clients with an access token")]
    public string PublicIp = "xxx.xxx.xxx.xxx";

    [Header("Other")] public bool QuitAppIfDisconnected = true;
