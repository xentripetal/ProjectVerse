...
public class MsfQuickBuild {
    ...
    public static string GetPath() {
        ...
        var path = EditorUtility.SaveFolderPanel("Choose Location for binaries", prevPath, "");

        if (!string.IsNullOrEmpty(path)) EditorPrefs.SetString("msf.buildPath", path);
        return path;
    }
