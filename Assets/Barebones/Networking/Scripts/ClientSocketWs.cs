...
namespace Barebones.Networking {
    ...
    public class ClientSocketWs : BaseClientSocket, IClientSocket, IUpdatable {
        ...
        public bool IsConnecting => _status == ConnectionStatus.Connecting;
        ...
        public void WaitConnection(Action<IClientSocket> connectionCallback, float timeoutSeconds) {
            ...
            onConnected = () => {
                ...
                if (!timedOut) connectionCallback.Invoke(this);
            };
        ...
        public void Disconnect() {
            ...
            if (_peer != null) _peer.Dispose();

            IsConnected = false; //EMIL Fix
        ...
        private void SetStatus(ConnectionStatus status) {
            switch (status) {
                case ConnectionStatus.Connecting:
                    if (Status != ConnectionStatus.Connecting) Status = ConnectionStatus.Connecting;
                    break;
