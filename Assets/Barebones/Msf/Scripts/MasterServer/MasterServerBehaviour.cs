...
namespace Barebones.MasterServer {
    ...
    public class MasterServerBehaviour : ServerBehaviour {
        ...
        protected override void Awake() {
            ...
            if (Msf.Args.IsProvided(Msf.Args.Names.MasterPort)) Port = Msf.Args.MasterPort;
        }

        protected virtual void Start() {
            if (Msf.Args.StartMaster || Msf.Runtime.IsEditor && AutoStartInEditor) StartCoroutine(StartOnNextFrame());
        }
        ...
        [Header("Master Server")] public HelpBox _hbInfo = new HelpBox {
        ...
        [Header("Editor settings")] public bool AutoStartInEditor = true;
