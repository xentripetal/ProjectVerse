...
namespace Barebones.MasterServer {
    ...
    public class Msf {
        ...
        /// </summary>
        public static IClientSocket Connection { get; }

        /// <summary>
        ///     Advanced master server framework settings
        /// </summary>
        public static MsfAdvancedSettings Advanced { get; }
        ...
        /// </summary>
        public static MsfServer Server { get; }

        public static MsfConcurrency Concurrency { get; }
        ...
        /// </summary>
        public static MsfSecurity Security { get; }

        /// <summary>
        ///     Default events channel
        /// </summary>
        public static EventsChannel Events { get; }

        /// <summary>
        ///     List of event names, used within the framework
        /// </summary>
        public static MsfEventNames EventNames { get; }

        /// <summary>
        ///     Contains methods, that work with runtime data
        /// </summary>
        public static MsfRuntime Runtime { get; }

        /// <summary>
        ///     Contains command line / terminal values, which were provided
        ///     when starting the process
        /// </summary>
        public static MsfArgs Args { get; }
        ...
        public class MsfEventNames {
            public string ShowLoading => "msf.loading";
            public string ShowDialogBox => "msf.showDialog";
            public string RestoreLoginForm => "msf.restoreLoginForm";
        }
        ...
        public class MsfCreate {
            ...
            /// <returns></returns>
            public ResponseCallback SuccessCallback(SuccessCallback callback,
                string unknownErrorMsg = "Unknown Error") {
