...
namespace Barebones.MasterServer {
    ...
    public class RegisteredRoom {
        ...
        private readonly Dictionary<int, IPeer> _players;

        private readonly HashSet<int> _requestsInProgress;
        ...
        public void GetAccess(IPeer peer, Dictionary<string, string> properties, GetAccessCallback callback) {
            ...
            if (userExt != null && !string.IsNullOrEmpty(userExt.Username)) packet.Username = userExt.Username;
