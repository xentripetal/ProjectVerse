...
namespace Barebones.MasterServer {
    public class RoomsModule : ServerModuleBehaviour, IGamesProvider {
        ...
        [Header("Permissions")] [Tooltip("Minimal permission level, necessary to register a room")]
        public int RegisterRoomPermissionLevel;
        ...
        private IEnumerator CleanUnconfirmedAccesses() {
            while (true) {
                ...
                foreach (var registeredRoom in Rooms.Values) registeredRoom.ClearTimedOutAccesses();
            }
        }
