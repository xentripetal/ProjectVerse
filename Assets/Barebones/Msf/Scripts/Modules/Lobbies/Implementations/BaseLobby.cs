...
namespace Barebones.MasterServer {
    public class BaseLobby : ILobby {
        ...
        protected LobbiesModule Module { get; }
        ...
        public void SetLobbyProperties(Dictionary<string, string> properties) {
            foreach (var property in properties) Properties[property.Key] = property.Value;
        }
        ...
        public void Destroy() {
            ...
            // Remove players
            foreach (var member in Members.Values.ToList()) RemovePlayer(member.Extension);
        ...
        public void Broadcast(IMessage message) {
            foreach (var peer in Subscribers) peer.SendMessage(message, DeliveryMethod.Reliable);
        }
