...
namespace Barebones.MasterServer {
    public class ObservableDictStringFloat : ObservableBase {
        ...
        /// </summary>
        public IEnumerable<float> Values => UnderlyingDictionary.Values;

        /// <summary>
        ///     Returns an immutable list of key-value pairs
        /// </summary>
        public IEnumerable<KeyValuePair<string, float>> Pairs => UnderlyingDictionary.ToList();

        /// <summary>
        ///     Returns a mutable dictionary
        /// </summary>
        public Dictionary<string, float> UnderlyingDictionary { get; }
        ...
        public override void DeserializeFromString(string value) {
            ...
            for (var i = 0; i < keys.Count; i++) UnderlyingDictionary[keys[i]] = list[i].f;
        }
