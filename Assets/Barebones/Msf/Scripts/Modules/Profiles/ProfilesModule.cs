...
namespace Barebones.MasterServer {
    ...
    public class ProfilesModule : ServerModuleBehaviour {
        ...
        /// </summary>
        public float ClientUpdateInterval;

        public IProfilesDatabase Database;

        public int EditProfilePermissionLevel;
        ...
        public override void Initialize(IServer server) {
            ...
            if (Database == null) Logger.Error("Profiles database implementation was not found");
            ...
            if (_auth != null) _auth.LoggedIn += OnLoggedIn;
                ...
                using (var reader = new EndianBinaryReader(EndianBitConverter.Big, ms)) {
                    ...
                    for (var i = 0; i < count; i++) {
                        ...
                        try {
                            ...
                            if (profile != null) profile.ApplyUpdates(updates);
                        }
                        catch (Exception e) {
        ...
        protected virtual void HandleClientProfileRequest(IIncommingMessage message) {
            ...
            if (!IgnoreProfileMissmatchError && clientPropCount != profileExt.Profile.PropertyCount)
                Logger.Error(string.Format("Client requested a profile with {0} properties, but server " +
                                           ...
                                           "profile factory on the ProfilesModule", clientPropCount,
                    profileExt.Profile.PropertyCount));
