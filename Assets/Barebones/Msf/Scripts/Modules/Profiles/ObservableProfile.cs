...
namespace Barebones.MasterServer {
    ...
    public class ObservableProfile : IEnumerable<IObservableProperty> {
        ...
        private readonly HashSet<IObservableProperty> _notBroadcastedProperties;
        private readonly Dictionary<short, IObservableProperty> _properties;
        ...
        public bool HasDirtyProperties => _notBroadcastedProperties.Count > 0;
        ...
        public void FromStrings(Dictionary<short, string> dataData) {
            foreach (var pair in dataData) {
                ...
                if (property != null) property.DeserializeFromString(pair.Value);
            }
        }
        ...
        public void ClearUpdates() {
            foreach (var property in _notBroadcastedProperties) property.ClearUpdates();
        ...
        public void ApplyUpdates(EndianBinaryReader reader) {
            ...
            foreach (var updateEntry in dataRead) {
                ...
                if (property != null) property.ApplyUpdates(updateEntry.Value);
            }
        }
        ...
        public Dictionary<short, string> ToStringsDictionary() {
            ...
            foreach (var pair in _properties) dict.Add(pair.Key, pair.Value.SerializeToString());
