...
namespace Barebones.MasterServer {
    public class SpawnerController {
        ...
        public DefaultSpawnerConfig Settings => DefaultSpawnerSettings;

        /// <summary>
        ///     Settings, which are used by the default spawn handler
        /// </summary>
        public DefaultSpawnerConfig DefaultSpawnerSettings { get; }
        ...
        private static readonly Dictionary<int, Process> _processes = new Dictionary<int, Process>();
                ...
                new Thread(() => {
                    try {
                        ...
                        Logger.Error(
                            ...
                            "We've tried to start a process at: '" + path +
        ...
        public static void KillProcessesSpawnedWithDefaultHandler() {
            ...
            lock (_processLock) {
                foreach (var process in _processes.Values) list.Add(process);
            }
        ...
        public class DefaultSpawnerConfig {
            ...
            public bool RunInBatchmode {
                get => SpawnInBatchmode;
                set => SpawnInBatchmode = value;
            }
        }
