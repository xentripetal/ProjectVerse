...
public class SpawnerBehaviour : MonoBehaviour {
    ...
    [Header("Spawner Settings")] public string DefaultMachineIp = "127.0.0.1";

    public bool DefaultSpawnInBatchmode;
    ...
    [Header("General")] [Tooltip("Log level of this script's logger")]
    public LogLevel LogLevel = LogLevel.Info;

    public int MaxSpawnedProcesses = 5;

    [Tooltip(
        "If true, and if running in editor, path to executable will be overriden, and a value from 'ExePathFromEditor' " +
        "will be used.")]
    ...
    protected virtual void OnConnectedToMaster() {
        ...
        if (AutoStartInEditor && Msf.Runtime.IsEditor) StartSpawner();
    }
    ...
    protected virtual void OnApplicationQuit() {
        if (KillProcessesWhenSpawnerQuits) SpawnerController.KillProcessesSpawnedWithDefaultHandler();
    }
