...
namespace Barebones.MasterServer {
    public class SpawnersModule : ServerModuleBehaviour {
        ...
        /// <returns></returns>
        public virtual List<RegisteredSpawner>
            GetFilteredSpawners(Dictionary<string, string> properties, string region) {
        ...
        [Header("Permissions")] [Tooltip("Minimal permission level, necessary to register a spanwer")]
        public int CreateSpawnerPermissionLevel;

        [Header("General")] public LogLevel LogLevel = LogLevel.Warn;
