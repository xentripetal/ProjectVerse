...
namespace Barebones.MasterServer {
    ...
    public class AuthModule : ServerModuleBehaviour {
        ...
        [TextArea(3, 10)] public string ActivationForm = "<h1>Activation</h1>" +
        ...
        public int GetPeerDataPermissionsLevel;
        ...
        [Header("Mail settings")] public Mailer Mailer;

        protected int NextGuestId;

        [TextArea(3, 10)] public string PasswordResetCode = "<h1>Password Reset Code</h1>" +
        ...
        protected virtual void HandleRequestEmailConfirmCode(IIncommingMessage message) {
            ...
            if (!Mailer.SendMail(extension.AccountData.Email, "E-mail confirmation",
