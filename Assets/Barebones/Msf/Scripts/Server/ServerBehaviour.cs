...
namespace Barebones.MasterServer {
    public class ServerBehaviour : MonoBehaviour, IServer {
        ...
        private readonly BmLogger Logger = Msf.Create.Logger(typeof(ServerBehaviour).Name);
        ...
        private void Disconnected(IPeer peer) {
            ...
            if (extension != null) PeersByGuidLookup.Remove(extension.UniqueGuid);
        ...
        public T GetModule<T>() where T : class, IServerModule {
            ...
            if (module == null) module = _modules.Values.FirstOrDefault(m => m is T);
