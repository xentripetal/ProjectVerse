    ...
    public class LiteDbFactory : MonoBehaviour {
        ...
        protected virtual void OnServerStarted() {
            ...
            try {
                ...
                Msf.Server.DbAccessors.SetAccessor<IProfilesDatabase>(
                    new ProfilesDatabaseLdb(new LiteDatabase(@"profiles.db")));
            }
            catch {
                Logs.Error(
                    "Failed to setup LiteDB. Try removing generated database files, because we've switched to V2 " +
